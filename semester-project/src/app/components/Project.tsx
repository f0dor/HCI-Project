...
const ProjectCard = () => {
    return (
        <div className="text-white font-roboto-mono py-5 flex flex-row items-center custom-background margin-project">
            ...
            <div className="flex flex-col justify-center items-start margin-project-text" style={{ height: '100%', width: "fit-content" }}>
                ...
                <a href="https://github.com/f0dor/Strukture-Podataka" className="py-1 flex flex-row">
                    <Image src="/images/github.png" alt="Hero section image" width={25} height={25} />
                    <span> &nbsp;github</span>
                </a>
            </div>
        </div>
